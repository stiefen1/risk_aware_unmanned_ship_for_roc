from submodules.ship_in_transit_simulator.models import ShipModel, ShipConfiguration, EnvironmentConfiguration, \
...
# Place obstacles
obstacle_data = np.loadtxt(os.path.join('tests', 'ship_in_transit_simulator', 'obstacles.txt'))
list_of_obstacles = []
...
auto_pilot = HeadingByRouteController(
    route_name=os.path.join('tests', 'ship_in_transit_simulator', "route.txt"),
